...
function()
	...
	ProbablyEngine.toggle.create('cleavemode', 'Interface\\Icons\\achievement_pvp_o_h', 'Cleave Mode', 'Toggle the automatic usage of AoE abilities for 2 to 3 enemies.')
